...
export const Footer = (props) => {
    ...
    const supporterLogos = props.supporterLogoPath
        ? <>
            <img src={prependBaseURL(`${props.supporterLogoPath}/footer-logo-vtt.webp`)} alt="VTT" className="h-10" />
            <img src={prependBaseURL(`${props.supporterLogoPath}/footer-logo-aalto.webp`)} alt="Aalto University" className="h-10" />
    ...
    const funderLogos = props.funderLogoPath
        ? <>
            <img src={prependBaseURL(`${props.funderLogoPath}/Academy_of_Finland.webp`)} alt="Academy of Finland" className="h-10" />
            <img src={prependBaseURL(`${props.funderLogoPath}/EU-RRF.webp`)} alt="EU Funding" className="h-10" />
        </>
        : <></>
