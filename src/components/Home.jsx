...
const ContentButton = ({ text, href, icon=mdiArrowDown }) => {
    ...
    return (
            <CButton
                className='w-min ml-[20px] mt-[10px] md:ml-0 md:mr-[20px] sm:ml-0 sm:ml-[30px] bg-[#0D2B53] hover:bg-blue-600'
                no-radius
                style={style}
...
export const Home = () => {
    return (
        <div className='min-w-[375px] h-auto xl:h-[850px] 2xl:h-[950px]'>
            ...
            <div className='h-[350px] sm:h-[300px] md:min-h-[320px] lg:min-h-[300px] xl:min-h-[300px] 2xl:min-h-[300px] xl:mr-0 2xl:mx-[150px] 2xl:mr-0 lg:ml-[50px] sm:pl-6 flex lg:flex-row lg:justify-start lg:items-start md:flex-col md:items-center lg:h-0 md:h-[25vw] sm: flex-col'>

                <div className='md:w-[80vw] lg:w-[500px] xl:w-[600px] 2xl:w-[700px]'>
                    <div style={{top: "-280px"}} className="md:pr-[250px] lg:pr-0 min-h-[300px] flex flex-col justify-between font-bold text-white leading-tight p-[30px] pr-[100px] sm:p-[30px] bg-[#0D2B53] relative top-[0px] xl:w-[600px] xl:h-[600px] 2xl:w-[700px] 2xl:h-[700px] lg:w-[500px] lg:h-[500px] md:w-[80vw] md:h-[420px] md:ml-0 sm:w-full sm:h-[400px]">
