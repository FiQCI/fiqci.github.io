...
const EventFilters = ({ filters, handleFilterChange }) => {
    ...
    return (
        <div className='flex flex-col gap-[24px] text-on-white max-h-[85vh] mb-[12px] overflow-y-auto'>
...
const FilterCategory = ({ category, options, handleCheckboxChange }) => (
    <div>
        <h3 className='font-bold mb-[2px]'>{category}</h3>
...
const FilterTheme = ({ selectedTheme, handleChangeTheme }) => (
    <div>
        <p className='font-bold mb-[2px]'>Theme</p>
        <CSelect
            hideDetails={true}
            className='py-2'
            clearable
