...
![](/assets/images/Circuit-Knitting-Blog/image-3.png)
...
![](/assets/images/Circuit-Knitting-Blog/reset.png)
...
![](/assets/images/Circuit-Knitting-Blog/wire_cut_example.png)


The subcircuits will then be

![](/assets/images/Circuit-Knitting-Blog/wire_cut_example_sub1.png) ![](/assets/images/Circuit-Knitting-Blog/wire_cut_example_sub2.png)
...
In order to use QCut (ck) we will also need some Qiskit components, such as QuantumCircuit and Estimator. We start by defining the initial and the cut circuits. 
...
![](/assets/images/Circuit-Knitting-Blog/circ1.png)
...
![](/assets/images/Circuit-Knitting-Blog/circ2.png)
...
![](/assets/images/Circuit-Knitting-Blog/circ3.png) ![](/assets/images/Circuit-Knitting-Blog/circ4.png)


![](/assets/images/Circuit-Knitting-Blog/results_bar_plot.png)
...
![](/assets/images/Circuit-Knitting-Blog/qaoa_graph.png)
...
![](/assets/images/Circuit-Knitting-Blog/qaoa_circuit.png)
...
![](/assets/images/Circuit-Knitting-Blog/qaoa_cut_circuit.png)

In the circuit, you can notice that the parameters are $ -2\pi $ instead of $ -\pi $ This is just because when constructing the circuit we multiply the parameters by 2. This is just a convention and has no effect on our results.
...
Solving the QAOA with Qiskits AerSimulator as our backend we can see that the results obtained are very close to the true minimum of -2 and that QCut is able to accurately estimate the cost function.

![](/assets/images/Circuit-Knitting-Blog/qaoa_QCut_results.png)
...
![](/assets/images/Circuit-Knitting-Blog/qaoa_QCut_sim_results2.png)
...
![](/assets/images/Circuit-Knitting-Blog/qaoa_result_states_reconstruct.png)
