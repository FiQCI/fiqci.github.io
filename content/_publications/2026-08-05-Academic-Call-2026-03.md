---
title: 'Open Call 3/2026 for Academic Projects for the VTT Q50, Aalto Q20, and LUMI-Q VLQ Quantum Computers'
date: 2026-08-05
...
*The 3rd 2026 Call for access to the VTT Q50, Aalto Q20, and LUMI-Q VLQ quantum computers is now open for users from Finnish higher-education 
institutions and research institutes. The Call is launched by the Finnish Quantum-Computing Infrastructure FiQCI, 
maintained and developed by VTT, CSC, and Aalto University. VTT Q50, operated by VTT, Aalto Q20, operated by Aalto University, and
the EuoHPC LUMI-Q VLQ, operated by IT4Innovations@VSB
are accessible through the EuroHPC LUMI supercomputer environment, hosted by the LUMI consortium led by CSC.*
...
with a quantum computing resources that exceed the capacity of full emulation on supercomputers.
...
With the VTT Q50, Aalto Q20, and the LUMI-Q VLQ quantum computers as part of FiQCI, also parallel quantum computing directly within a supercomputer
environment can be explored.

## Timeline of Call

  - **5 Aug 2026** Call opens
  - **23 Aug 2026** Call closes
  - **7 Sep 2026** (tentative) Outcome communicated

## How to apply

Access to the VTT Q50, Aalto Q20, and LUMI-Q VLQ machines is organised through regular Calls. Calls are planned at least four times per year.

**The deadline for Call 3/2026 is 23 Aug 2026**. Proposals will be evaluated within FiQCI as soon as possible after the deadline.
...
The application form is available here: [Application form for FiQCI Academic Projects 3/2026](https://link.webropolsurveys.com/S/3F77A42C7C75F309)
...
The total available QPU time available per Call is approximately 1,000 QPU-hours, and we expect to grant resources to several projects.
...
If you need additional supporting classical resources _related_ to the project, but not necessary for running the quantum jobs,
you should apply for a separate LUMI project for these.
...
Accepted Projects must accept the Terms of Use for the LUMI supercomputing environment and, if applicable, the VTT Q50 and LUMI-Q VLQ systems.
...
When publishing the results that utilise VTT Q50, Aalto Q20, and/or EuroHPC LUMI-Q VLQ, users have to acknowledge the use of VTT Quantum, Aalto Q20, 
EuroHPC LUMI-Q VLQ and FiQCI, preferably in the format: 
  ...
  - "These [results] have been acquired by the use of the LUMI-Q VLQ quantum computer, owned by the EuroHPC Joint Undertaking, hosted by IT4I@VSB (Czechia) and the LUMI-Q consortium". Users should use "LUMI-Q VLQ" when referring to the quantum computer.
  - "The authors acknowledge the use of the Finnish Quantum-Computing Infrastructure FiQCI."

## Questions and clarifications.

Please direct any and all questions regarding the Call to [servicedesk@csc.fi](mailto:servicedesk@csc.fi). We are happy to help!
