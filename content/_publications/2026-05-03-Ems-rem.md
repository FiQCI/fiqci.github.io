...
Even though this is the most straightforward way to apply readout error mitigation, it is **not** how EMS applies readout error mitigation as the REM method in FiQCI EMS is based on Matrix-free measurement mitigation [5](#references).
...
5. [https://qiskit.github.io/qiskit-addon-mthree/](https://qiskit.github.io/qiskit-addon-mthree/) [Accessed: Jun. 3 2026]
6. [https://github.com/Qiskit/qiskit-addon-mthree/blob/main/mthree/iterative.py](https://github.com/Qiskit/qiskit-addon-mthree/blob/main/mthree/iterative.py) [Accessed: Jan. 12 2026]
